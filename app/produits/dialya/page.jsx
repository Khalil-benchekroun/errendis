...
export const metadata = {
  ...
  alternates: { canonical: '/produits/dialya' },
  openGraph: {
    title: product.seoTitle,
    description: product.seoDescription,
    url: '/produits/dialya',
    images: [{ url: '/og/dialya-og.png', width: 1200, height: 630, alt: product.seoTitle }],
  },
  twitter: {
    card: 'summary_large_image',
    title: product.seoTitle,
    description: product.seoDescription,
    images: ['/og/dialya-og.png'],
  },
  icons: {
    icon: [
      { url: '/favicons/dialya-16.png', sizes: '16x16', type: 'image/png' },
      { url: '/favicons/dialya-32.png', sizes: '32x32', type: 'image/png' },
    ],
    apple: '/favicons/dialya-apple.png',
  },
};

export default function DialyaPage() {
  ...
  const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: product.seoDescription,
    image: 'https://errendis.com/og/dialya-og.png',
