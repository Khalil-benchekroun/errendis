...
const product = getProduct('batira');

export const metadata = {
  title: product.seoTitle,
  description: product.seoDescription,
  alternates: { canonical: '/produits/batira' },
  openGraph: { title: product.seoTitle, description: product.seoDescription, url: '/produits/batira', images: [{ url: '/og/batira-og.png', width: 1200, height: 630, alt: product.seoTitle }] },
  twitter: { card: 'summary_large_image', title: product.seoTitle, description: product.seoDescription, images: ['/og/batira-og.png'] },
  icons: { icon: [{ url: '/favicons/batira-16.png', sizes: '16x16', type: 'image/png' }, { url: '/favicons/batira-32.png', sizes: '32x32', type: 'image/png' }], apple: '/favicons/batira-apple.png' },
};

export default function BatiraPage() {
  ...
  const jsonLd = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: product.name, applicationCategory: 'BusinessApplication', operatingSystem: 'Web', description: product.seoDescription, image: 'https://errendis.com/og/batira-og.png', publisher: { '@type': 'Organization', name: 'Errendis' } };
  const breadcrumbJsonLd = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: 'https://errendis.com/' }, { '@type': 'ListItem', position: 2, name: 'Produits', item: 'https://errendis.com/#produits' }, { '@type': 'ListItem', position: 3, name: product.name, item: 'https://errendis.com/produits/batira' }] };
