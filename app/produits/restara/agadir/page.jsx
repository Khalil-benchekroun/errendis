...
export const metadata = {
  title: 'Logiciel gestion restaurant Agadir — Restara par Errendis',
  description: 'Restara : logiciel de gestion pour restaurants et cafés à Agadir. Caisse tactile, plan de salle, menu QR, écran cuisine KDS, stocks et fidélité client.',
  alternates: { canonical: '/produits/restara/agadir' },
  openGraph: {
    title: 'Logiciel gestion restaurant Agadir — Restara',
    description: 'Logiciel de gestion pour restaurants et cafés à Agadir : caisse, plan de salle, menu QR, KDS, stocks et fiches techniques.',
    url: '/produits/restara/agadir',
    images: [{ url: '/og/restara-og.png', width: 1200, height: 630, alt: 'Restara — Logiciel restaurant Agadir' }],
  },
};
...
const localBusinessJsonLd = {
  ...
  name: 'Restara — Logiciel gestion restaurant Agadir',
  applicationCategory: 'BusinessApplication',
  operatingSystem: 'Web',
  description: 'Logiciel de gestion pour restaurants et cafés à Agadir, Souss-Massa.',
  url: `${SITE_URL}/produits/restara/agadir`,
  publisher: {
    '@type': 'Organization',
    name: 'Errendis',
    url: SITE_URL,
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Agadir', item: `${SITE_URL}/produits/restara/agadir` },
  ],
};
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Restara propose-t-il un menu digital QR pour les restaurants de Agadir ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Oui, Restara inclut un menu digital accessible par QR code, modifiable en temps réel depuis le back-office. Idéal pour les restaurants de Agadir qui accueillent une clientèle touristique internationale.',
      },
    },
    {
      '@type': 'Question',
      name: 'Combien de temps pour déployer Restara dans mon restaurant à Agadir ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'La mise en service de Restara prend généralement 1 à 2 jours. Nous configurons votre carte, votre plan de salle et vos fiches techniques, puis formons votre équipe sur site à Agadir ou à distance.',
      },
    },
  ],
};
...
export default function RestaraAgadirPage() {
  return (
    <>
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <span className="section-eyebrow">Logiciel gestion restaurant · Agadir</span>
          <h1>Restara — Logiciel de gestion pour restaurant et café à Agadir</h1>
          <p>
            Agadir, station balnéaire avec une offre restauration orientée tourisme.
            La restauration d'Agadir est fortement orientée tourisme avec une clientèle internationale. La gestion des stocks est critique pour éviter les ruptures en haute saison et les pertes en basse saison.
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <h2>Ce que Restara fait pour votre restaurant à Agadir</h2>
          </div>
          <div className="sectors-grid">
            ...
            <div className="sector-item">
              ...
              <p>
                ...
                à Agadir en temps réel. Assignez les serveurs et suivez le statut
            ...
            <div className="sector-item">
              ...
              <p>
                ...
                back-office. Idéal pour les restaurants de Agadir qui accueillent
      ...
      <section className="section section--alt">
        <div className="container">
          <div className="section-head">
            <span className="section-eyebrow">Restara à Agadir</span>
            <h2>Pourquoi les restaurants de Agadir choisissent Restara</h2>
          </div>
          <div className="why-grid">
            ...
            <div className="why-item">
              ...
              <p>
                ...
                basée au Maroc. Un problème en plein service à Agadir ?
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <h2>Restara à Agadir — vos questions</h2>
          </div>
          <div className="faq-list" style={{ maxWidth: 820 }}>
            <details className="faq-item">
              <summary>Restara convient-il aux restaurants de Agadir ?</summary>
              <p>
                Oui. La restauration d'Agadir est fortement orientée tourisme avec une clientèle internationale. La gestion des stocks est critique pour éviter les ruptures en haute saison et les pertes en basse saison. Restara s&apos;adapte à ces réalités
                avec une caisse rapide, un écran cuisine et une gestion des stocks intégrée.
              </p>
            </details>
            <details className="faq-item">
              <summary>Restara propose-t-il un menu digital QR pour Agadir ?</summary>
              <p>
                Oui, Restara inclut un menu digital accessible par QR code, modifiable
                en temps réel. Idéal pour les restaurants de Agadir qui accueillent
                une clientèle touristique internationale.
              </p>
            </details>
            <details className="faq-item">
              <summary>Combien de temps pour déployer Restara à Agadir ?</summary>
              <p>
                ...
                puis formons votre équipe sur site à Agadir ou à distance.
              </p>
            </details>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          <div className="cta-band">
            <h2>Prêt à digitaliser votre restaurant à Agadir ?</h2>
            <p>
              Réservez une démonstration gratuite et voyez Restara en action
              sur les réalités de votre établissement à Agadir.
            </p>
            <Link href="/contact" className="btn btn--primary">
