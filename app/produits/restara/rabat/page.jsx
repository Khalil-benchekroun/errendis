...
export const metadata = {
  title: 'Logiciel gestion restaurant Rabat — Restara par Errendis',
  description: 'Restara : logiciel de gestion pour restaurants et cafés à Rabat. Caisse tactile, plan de salle, menu QR, écran cuisine KDS, stocks et fidélité client.',
  alternates: { canonical: '/produits/restara/rabat' },
  openGraph: {
    title: 'Logiciel gestion restaurant Rabat — Restara',
    description: 'Logiciel de gestion pour restaurants et cafés à Rabat : caisse, plan de salle, menu QR, KDS, stocks et fiches techniques.',
    url: '/produits/restara/rabat',
    images: [{ url: '/og/restara-og.png', width: 1200, height: 630, alt: 'Restara — Logiciel restaurant Rabat' }],
  },
};
...
const localBusinessJsonLd = {
  ...
  name: 'Restara — Logiciel gestion restaurant Rabat',
  applicationCategory: 'BusinessApplication',
  operatingSystem: 'Web',
  description: 'Logiciel de gestion pour restaurants et cafés à Rabat, Rabat-Salé-Kénitra.',
  url: `${SITE_URL}/produits/restara/rabat`,
  publisher: {
    '@type': 'Organization',
    name: 'Errendis',
    url: SITE_URL,
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Rabat', item: `${SITE_URL}/produits/restara/rabat` },
  ],
};
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Restara propose-t-il un menu digital QR pour les restaurants de Rabat ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Oui, Restara inclut un menu digital accessible par QR code, modifiable en temps réel depuis le back-office. Idéal pour les restaurants de Rabat qui accueillent une clientèle touristique internationale.',
      },
    },
    {
      '@type': 'Question',
      name: 'Combien de temps pour déployer Restara dans mon restaurant à Rabat ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'La mise en service de Restara prend généralement 1 à 2 jours. Nous configurons votre carte, votre plan de salle et vos fiches techniques, puis formons votre équipe sur site à Rabat ou à distance.',
      },
    },
  ],
};
...
export default function RestaraRabatPage() {
  return (
    <>
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <span className="section-eyebrow">Logiciel gestion restaurant · Rabat</span>
          <h1>Restara — Logiciel de gestion pour restaurant et café à Rabat</h1>
          <p>
            Rabat, capitale du Maroc avec une clientèle administrative et diplomatique.
            La clientèle de Rabat est composée de fonctionnaires, de diplomates et d'une classe moyenne aisée. Les restaurants misent sur la qualité et le service plutôt que sur le volume, ce qui impose une gestion rigoureuse des coûts et des stocks.
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <h2>Ce que Restara fait pour votre restaurant à Rabat</h2>
          </div>
          <div className="sectors-grid">
            ...
            <div className="sector-item">
              ...
              <p>
                ...
                à Rabat en temps réel. Assignez les serveurs et suivez le statut
            ...
            <div className="sector-item">
              ...
              <p>
                ...
                back-office. Idéal pour les restaurants de Rabat qui accueillent
      ...
      <section className="section section--alt">
        <div className="container">
          <div className="section-head">
            <span className="section-eyebrow">Restara à Rabat</span>
            <h2>Pourquoi les restaurants de Rabat choisissent Restara</h2>
          </div>
          <div className="why-grid">
            ...
            <div className="why-item">
              ...
              <p>
                ...
                basée au Maroc. Un problème en plein service à Rabat ?
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <h2>Restara à Rabat — vos questions</h2>
          </div>
          <div className="faq-list" style={{ maxWidth: 820 }}>
            <details className="faq-item">
              <summary>Restara convient-il aux restaurants de Rabat ?</summary>
              <p>
                Oui. La clientèle de Rabat est composée de fonctionnaires, de diplomates et d'une classe moyenne aisée. Les restaurants misent sur la qualité et le service plutôt que sur le volume, ce qui impose une gestion rigoureuse des coûts et des stocks. Restara s&apos;adapte à ces réalités
                avec une caisse rapide, un écran cuisine et une gestion des stocks intégrée.
              </p>
            </details>
            <details className="faq-item">
              <summary>Restara propose-t-il un menu digital QR pour Rabat ?</summary>
              <p>
                Oui, Restara inclut un menu digital accessible par QR code, modifiable
                en temps réel. Idéal pour les restaurants de Rabat qui accueillent
                une clientèle touristique internationale.
              </p>
            </details>
            <details className="faq-item">
              <summary>Combien de temps pour déployer Restara à Rabat ?</summary>
              <p>
                ...
                puis formons votre équipe sur site à Rabat ou à distance.
              </p>
            </details>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          <div className="cta-band">
            <h2>Prêt à digitaliser votre restaurant à Rabat ?</h2>
            <p>
              Réservez une démonstration gratuite et voyez Restara en action
              sur les réalités de votre établissement à Rabat.
            </p>
            <Link href="/contact" className="btn btn--primary">
