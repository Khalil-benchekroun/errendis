...
const product = getProduct('medira');

export const metadata = {
  title: product.seoTitle,
  description: product.seoDescription,
  alternates: { canonical: '/produits/medira' },
  openGraph: {
    title: product.seoTitle,
    description: product.seoDescription,
    url: '/produits/medira',
    images: [{ url: '/og/medira-og.png', width: 1200, height: 630, alt: product.seoTitle }],
  },
  twitter: {
    card: 'summary_large_image',
    title: product.seoTitle,
    description: product.seoDescription,
    images: ['/og/medira-og.png'],
  },
  icons: {
    icon: [
...
export default function MediraPage() {
  ...
  const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: product.seoDescription,
    image: 'https://errendis.com/og/medira-og.png',
