...
export const metadata = {
  ...
  alternates: { canonical: '/produits/labya' },
  openGraph: {
    title: product.seoTitle,
    description: product.seoDescription,
    url: '/produits/labya',
    images: [{ url: '/og/labya-og.png', width: 1200, height: 630, alt: product.seoTitle }],
  },
  twitter: {
    card: 'summary_large_image',
    title: product.seoTitle,
    description: product.seoDescription,
    images: ['/og/labya-og.png'],
  },
  icons: {
    icon: [
...
export default function LabyaPage() {
  ...
  const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: product.seoDescription,
    image: 'https://errendis.com/og/labya-og.png',
