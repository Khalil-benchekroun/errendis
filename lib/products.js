...
export const products = [
...

  {
    ...
    seoDescription:
      'Dialya structure votre centre d\u2019hémodialyse : dossier patient, planning des séances, séances en direct, biologie, générateurs, stock et facturation AMO/CNOPS/CNSS.',
    pitch:
    ...
    modules: [
      {
        ...
        text: 'Antécédents, accès vasculaires, sérologies et historique de séances : toute l\u2019histoire du patient au même endroit, accessible en quelques secondes.',
        points: ['Antécédents et comorbidités', 'Accès vasculaires suivis', 'Historique complet des séances'],
      },
      {
        title: 'Planning des séances',
        text: 'Postes, générateurs et créneaux organisés visuellement. Glissez-déposez pour réaffecter un patient en quelques secondes, sans reconstruire tout le planning.',
        points: ['Vue par poste et par générateur', 'Réaffectation en glisser-déposer', 'Alertes de conflit'],
      },
      {
      ...
      },
      {
        ...
        text: 'Prescriptions de dialyse et protocoles médicamenteux, avec signature électronique tracée pour une conformité totale.',
        points: ['Protocoles médicamenteux', 'Signature électronique tracée', 'Historique des prescriptions'],
      },
      {
        title: 'Biologie & alertes intelligentes',
        text: 'Intégration laboratoire par HL7 ou API, avec des règles d\u2019alerte personnalisables par le centre pour ne jamais manquer une valeur critique.',
      ...
      },
      {
        ...
        text: 'Désinfection, compteurs horaires et maintenance préventive tracés machine par machine, pour répondre aux exigences réglementaires.',
      ...
      },
      {
        ...
        text: 'CNOPS, CNSS, AMO Tadamon et mutuelles : bordereaux, rejets et rapprochement bancaire gérés nativement.',
        points: ['CNOPS, CNSS, AMO Tadamon', 'Gestion des rejets', 'Rapprochement bancaire'],
      },
      {
        title: 'Portail patient',
        text: 'Une application mobile incluse qui garde le lien avec le patient entre les séances : rappels, documents, communication avec le centre.',
        points: ['Application mobile incluse', 'Rappels de séance', 'Communication avec le centre'],
      },
    ],
    features: [
      ...
      { title: 'Portail patient', text: 'Application mobile incluse.' },
    ],
    trust: [
      ...
      { title: 'Conçu avec des néphrologues', text: 'Le vocabulaire, les alertes et les protocoles collent à la réalité clinique.' },
    ...
    faqs: [
      ...
      {
        q: 'Le portail patient nécessite-t-il une application à installer ?',
        a: 'Le portail patient est accessible en application mobile ou directement depuis un navigateur, selon la préférence du patient.',
      },
      {
