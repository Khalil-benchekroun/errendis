    ...
    features: [
      {
        ...
        text: 'Antécédents, prescriptions, accès vasculaires, sérologies : toute l\u2019histoire du patient au même endroit.',
      },
      {
        title: 'Planification des séances',
        text: 'Postes, générateurs et créneaux organisés visuellement, poste par poste, jour par jour.',
      },
      {
        title: 'Suivi per-dialytique',
        text: 'Paramètres de séance, incidents et transmissions saisis au fil de l\u2019eau par l\u2019équipe soignante.',
      },
      {
        title: 'Traçabilité du matériel',
        text: 'Générateurs, dialyseurs et consommables tracés pour répondre aux exigences réglementaires.',
      },
      {
        title: 'Alertes médicales',
        text: 'Valeurs critiques et échéances de bilans signalées automatiquement au bon moment.',
      },
      {
        title: 'Facturation & organismes',
        text: 'Prise en charge AMO / CNOPS / CNSS et suivi des dossiers de remboursement.',
      },
    ],
